...
OCESQL*
OCESQL 01  SQ0001.
OCESQL     02  FILLER PIC X(034) VALUE "SELECT * FROM EMP WHERE EMP_NO"
OCESQL  &  " > 4".
...
OCESQL*
      ...
      *    SHOW RESULT
OCESQL*    EXEC SQL
OCESQL*        SELECT * INTO :READ-TBL FROM EMP WHERE EMP_NO > 4
OCESQL*    END-EXEC.
...
OCESQL          BY VALUE 4
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE READ-NO(1)
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 16
OCESQL          BY VALUE 20
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE READ-NAME(1)
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 3
OCESQL          BY VALUE 4
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE READ-SALARY(1)
OCESQL     END-CALL
