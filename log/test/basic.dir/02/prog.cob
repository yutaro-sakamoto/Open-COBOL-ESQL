...
OCESQL*
OCESQL 01  SQ0002.
OCESQL     02  FILLER PIC X(022) VALUE "SELECT EMP-NO FROM EMP".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0003.
OCESQL     02  FILLER PIC X(034) VALUE "SELECT EMP-NO, EMP-SALARY FROM"
OCESQL  &  " EMP".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
OCESQL 01  SQ0004.
...
OCESQL     END-CALL.
      ...
      * Test case 0002 *************************************************
OCESQL*EXEC SQL
OCESQL*    DECLARE CURSOR2 CURSOR FOR SELECT EMP-NO FROM EMP
OCESQL*END-EXEC.
OCESQL     CALL "OCESQLCursorDeclare" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "prog_CURSOR2" & x"00"
...
OCESQL     END-CALL.
      ...
      * Test case 0003 *************************************************
OCESQL*EXEC SQL
OCESQL*    DECLARE CURSOR3 CURSOR FOR SELECT EMP-NO, EMP-SALARY FROM EMP
OCESQL*END-EXEC.
OCESQL     CALL "OCESQLCursorDeclare" USING
OCESQL          BY REFERENCE SQLCA
OCESQL          BY REFERENCE "prog_CURSOR3" & x"00"
